...
Logs: tail -f /tmp/srbench_smallpop.log   |   rows: /tmp/srbench_smallpop.jsonl
"""
...
LOG = "/tmp/srbench_smallpop.log"
JSONL = "/tmp/srbench_smallpop.jsonl"
SEED = 11
N_PROBLEMS = 9
BUDGET = 450.0      # + extraction tail (40-260s) ~= 8-12 min per problem
N_GEN = 5000        # high enough that the time budget always binds first
POP_INTAKE = 100
POP_CHAMP = 50
PARS_COL_MAX = 200.0
...
def run_problem(name: str) -> dict:
    ...
    os.environ["HFF_HOF_DUMP"] = f"/tmp/hff_hof_smallpop_{safe_name}.pkl"
...
def main():
    ...
    log(f"=== SRBench small-pop long-gen sweep START === {N_PROBLEMS} problems, seed={SEED}, "
