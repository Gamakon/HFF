...
Logs: tail -f /tmp/srbench_200g.log   |   rows: /tmp/srbench_200g.jsonl
"""
...
LOG = "/tmp/srbench_200g.log"
JSONL = "/tmp/srbench_200g.jsonl"
SEED = 11
N_PROBLEMS = 9
BUDGET = 900.0      # safety ceiling; N_GEN=200 is the intended stop
N_GEN = 200         # standard test config: ~2s/gen -> ~7-11 min/problem
POP_INTAKE = 100
POP_CHAMP = 50
PARS_COL_MAX = 200.0
...
def run_problem(name: str) -> dict:
    ...
    os.environ["HFF_HOF_DUMP"] = f"/tmp/hff_hof_200g_{safe_name}.pkl"
...
def main():
    ...
    log(f"=== SRBench small-pop 200-gen sweep START === {N_PROBLEMS} problems, seed={SEED}, "
