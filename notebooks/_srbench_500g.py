...
Logs: tail -f /tmp/srbench_500g.log   |   rows: /tmp/srbench_500g.jsonl
"""
...
LOG = "/tmp/srbench_500g.log"
JSONL = "/tmp/srbench_500g.jsonl"
SEED = 11
N_PROBLEMS = 9
BUDGET = 1500.0     # safety ceiling; N_GEN=500 is the intended stop
N_GEN = 500         # generation-bound run (user-requested)
POP_INTAKE = 100
POP_CHAMP = 50
PARS_COL_MAX = 200.0
...
def run_problem(name: str) -> dict:
    ...
    os.environ["HFF_HOF_DUMP"] = f"/tmp/hff_hof_500g_{safe_name}.pkl"
...
def main():
    ...
    log(f"=== SRBench small-pop 500-gen sweep START === {N_PROBLEMS} problems, seed={SEED}, "
